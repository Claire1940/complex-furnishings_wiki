...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Complex Furnishings Wiki',
    description: 'Copyright and intellectual property information for Complex Furnishings Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Complex Furnishings Wiki',
      description: 'Copyright and intellectual property information for Complex Furnishings Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Complex Furnishings Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Complex Furnishings Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Complex Furnishings Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Complex Furnishings Developers</strong> - Creators of the Complex Furnishings game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Complex Furnishings</strong> - Trademark of the game developers</li>
              <li><strong>Complex Furnishings Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Complex Furnishings Wiki.
            </p>
            ...
            <p>
              ...
              Complex Furnishings Wiki<br />
              Email: <a href="mailto:dmca@complex-furnishings.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@complex-furnishings.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Complex Furnishings Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Complex Furnishings Wiki (complex-furnishings.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@complex-furnishings.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@complex-furnishings.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@complex-furnishings.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@complex-furnishings.wiki</a>
            </p>
            <p>
