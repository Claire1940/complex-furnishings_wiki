...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.complex-furnishings.wiki'
  const path = '/about'

  return {
    title: 'About Complex Furnishings Wiki - Your Ultimate Roblox Game Resource',
    description: 'Learn about Complex Furnishings Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Complex Furnishings Roblox game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Complex Furnishings Wiki',
      title: 'About Complex Furnishings Wiki',
      description: 'Learn about our mission to provide the best Complex Furnishings game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: 'Complex Furnishings Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Complex Furnishings Wiki',
      description: 'Learn about our mission to provide the best Complex Furnishings game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Complex Furnishings Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Complex Furnishings
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Complex Furnishings Wiki</h2>
            <p>
              Complex Furnishings Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Roblox game "Complex Furnishings". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Complex Furnishings Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Complex Furnishings players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Complex Furnishings Wiki as the <strong>go-to destination</strong> for every Complex Furnishings player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Complex Furnishings Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Complex Furnishings Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Complex Furnishings as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Complex Furnishings mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Complex Furnishings Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Complex Furnishings or any official entities.
            </p>
            <p>
            ...
            <p>
              Complex Furnishings Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@complex-furnishings.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@complex-furnishings.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@complex-furnishings.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@complex-furnishings.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@complex-furnishings.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@complex-furnishings.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@complex-furnishings.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@complex-furnishings.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Complex Furnishings news.
